...
class Customizer_Library_Select_District_Control extends WP_Customize_Control {

	/**
	 * Control Type
	 */
	public $type = 'select-district';
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'customizer-select-district-control', $this->abs_path_to_url( dirname( __FILE__ ) . '/js/customizer-select-district-control.js' ), array( 'jquery' ), rand(), true );

		wp_enqueue_style( 'select2', 'https://cdn.jsdelivr.net/npm/select2@4.0.13/dist/css/select2.min.css', array(), rand() );
		wp_enqueue_style( 'customizer-select-district-control', $this->abs_path_to_url( dirname( __FILE__ ) . '/css/customizer-select-district-control.css' ), array(), rand() );
	}
	...
	public function render_content() {
		...
		<select id="<?php echo esc_attr( $this->id ); ?>" class="customizer-select2" <?php $this->link(); ?>>
			<?php if( $value ){?>
